...
async def upload_image(
    ...
    save_dir = "C:/Users/lenovo/Desktop/server/assets"
...
def check_image(model: str,imageName: str):
    ...
    server_dir = 'C:/Users/lenovo/Desktop/server/'
    print("model",model)
    print("imageName",imageName)
    if model=='helmet-yolov5s' or model == 'helmet-yolov5m':
        ...
        Data = detect.myDetect(inputSource=f"C:/Users/lenovo/Desktop/server/assets/{imageName}",outputPath="C:/Users/lenovo/Desktop/server//output",opt_cfg=f"C:/Users/lenovo/Desktop/server/yolov3/cfg/{model}.cfg",currentWeights=f"C:/Users/lenovo/Desktop/server/yolov3/models/{model}.pt",opt_names="C:/Users/lenovo/Desktop/server/yolov3/helmet.names")
        print(Data)
    return {"masg":"ok",
...
def check_video(model: str,videoName: str):
    ...
    if model == 'helmet-yolov5s' or model == 'helmet-yolov5m':
        ...
        Data = detect.myDetect(inputSource=f"C:/Users/lenovo/Desktop/server/assets/{videoName}",outputPath="C:/Users/lenovo/Desktop/server/output",opt_cfg=f"C:/Users/lenovo/Desktop/server/yolov3/cfg/{model}.cfg",currentWeights=f"C:/Users/lenovo/Desktop/server/yolov3/models/{model}.pt",opt_names="C:/Users/lenovo/Desktop/server/yolov3/helmet.names")
        print(Data)
    # return {"masg":"ok",
    ...
    return {"masg": "ok",
            "videoUrl": f"http://127.0.0.1:81/api/output/{videoName}?random={random.randrange(1, 1000)}",
            "appVideoUrl": "https://static-1259365379.cos.ap-chengdu.myqcloud.com/tmp57qfcnhw.mp4"}
...
def check_camera(model: str):
    ...
    if model == 'helmet-yolov5s' or model == 'helmet-yolov5m':
        ...
        detect.myDetect(inputSource="0", opt_cfg=f"C:/Users/lenovo/Desktop/server/yolov3/cfg/{model}.cfg",currentWeights=f"C:/Users/lenovo/Desktop/server/yolov3/models/{model}.pt",opt_names="C:/Users/lenovo/Desktop/server/yolov3/helmet.names")
    return {"msg":"ok"}
